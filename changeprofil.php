<?php
	...
	if(isset($_POST["changer"])){
		...
		if(!empty($_POST["password"])){
			_setAttribut("password", password_hash($_POST["password"], PASSWORD_DEFAULT), $_SESSION["login"], $co);
		}
		if(!empty($_POST["role"])){
        	...
        	<tr>
			      ...
			      <td><input type='password' id='password' name='password'></td>
					...
					<tr>
						...
						<td><input type='radio' name='role' value='Adherent'>  Adhérent    
				  	<br><input type='radio' name='role' value='Visiteur'>  Visiteur
				  	<br><input type='radio' name='role' value='Gestionnaire'>  Gestionnaire</td>
					</tr>
		 		</table>
