...
if(!empty($_POST['Commentaire'])){
	...
	header("Location:commentaires.php?comm=".$_GET['comm']);
}
...
echo "<div class='container'>
	 	...
	 	echo "<a href='authentification.php'><button id='newEv' class='bouton'>Se connecter pour laisser un commentaire</button></a>
	 	<br>
	 	<br>
	 	<br>
	 	<br>";
